				            ...
				            <tr>
				            	<th>
									...
									while ($linea=mysqli_fetch_array($registros))
									{
										...
										<td><a href='bormateriales.php?clave=$linea[aparato]'><img src='./img/borrar.jpg' width='30'></a></td></tr>";
				...
				<div class="heading">
					...
					<form name="incidencias" id="incidencias" method="post" action="rIncidencias.php">
								...
								<table align="center" width="40%">
									<tr>
										<td>Incidencia: </td>
										<td><input type="text" name="incidencia" id="incidencia" >
									</tr>
									<tr>
										<td>Fecha de la incidencia: </td>
										<td><input type="date" name="fechain" id="fechain" >
									</tr>
									<tr>
										<td>solucion: </td>
										<td><input type="text" name="solucion" id="solucion" >
									</tr>
